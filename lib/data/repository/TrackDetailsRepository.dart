...
abstract class TrackDetailsRepository {
  Future<Message> getTrackDetails(String track_id);
}

class TrackDetailsImpl implements TrackDetailsRepository {
  @override
  Future<Message> getTrackDetails(String track_id) async {
    var res = await http.get(Uri.parse(
        "https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${track_id}&apikey=d224b62664ddcc1f57b94acb41d76f9d"));
