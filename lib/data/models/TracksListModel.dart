...
TracksListModel tracksListModelFromJson(String str) => TracksListModel.fromJson(json.decode(str));

String tracksListModelToJson(TracksListModel data) => json.encode(data.toJson());
...
class TracksListModel {
  ...
  factory TracksListModel.fromJson(Map<String, dynamic> json) => TracksListModel(
