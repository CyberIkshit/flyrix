...
TrackDetailsModel trackDetailsModelFromJson(String str) => TrackDetailsModel.fromJson(json.decode(str));

String trackDetailsModelToJson(TrackDetailsModel data) => json.encode(data.toJson());
...
class TrackDetailsModel {
  ...
  factory TrackDetailsModel.fromJson(Map<String, dynamic> json) => TrackDetailsModel(
